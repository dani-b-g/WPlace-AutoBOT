(async () => {
  ...
  const TEXTS = {
    ...
    es: {
      ...
      checkingColors: "🔍 Comprobando colores disponibles...",
      ...
      selectPositionAlert: "¡Pinta el primer píxel en la ubicación donde quieras que comience el arte!",
      waitingPosition: "👆 Esperando a que pintes el píxel de referencia...",
      positionSet: "✅ ¡Posición establecida con éxito!",
      positionTimeout: "❌ Tiempo de espera agotado para la selección de posición",
      startPaintingMsg: "🎨 Iniciando pintura...",
      ...
      waitingInit: "Esperando la inicialización...",
      resizeSuccess: "✅ Imagen redimensionada a {width}x{height}",
      paintingPaused: "⏸️ Pintura en pausa en la posición X: {x}, Y: {y}"
    }
  };
